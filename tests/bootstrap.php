...
require_once dirname( __DIR__ ) . '/includes/class-is-email-auth.php';
require_once dirname( __DIR__ ) . '/includes/class-is-tls-check.php';
require_once dirname( __DIR__ ) . '/includes/class-is-ip-list.php';
require_once dirname( __DIR__ ) . '/includes/class-is-deception.php';
require_once dirname( __DIR__ ) . '/includes/class-is-login.php';
require_once dirname( __DIR__ ) . '/includes/class-is-login-design.php';
...
require_once dirname( __DIR__ ) . '/includes/class-is-rate-limiter.php';
require_once dirname( __DIR__ ) . '/includes/class-is-detections.php';
require_once dirname( __DIR__ ) . '/includes/class-is-custom-detections.php';
...
require_once dirname( __DIR__ ) . '/includes/class-is-api-key-hygiene.php';
require_once dirname( __DIR__ ) . '/includes/class-is-asset-cloak.php';
require_once dirname( __DIR__ ) . '/includes/class-is-password-policy.php';
require_once dirname( __DIR__ ) . '/includes/class-is-vulnerability-scanner.php';
require_once dirname( __DIR__ ) . '/includes/class-is-signatures.php';
require_once dirname( __DIR__ ) . '/includes/class-is-threat-intel.php';
require_once dirname( __DIR__ ) . '/includes/class-is-sbom.php';
